...
// -------------------------------------------------------------------------
// [경희대학교 전자공학과 2024학년도 교육과정 데이터]
// 출처: 전자공학부 홈페이지(ee.khu.ac.kr) > 학부 > 교육과정 >
//       "2024학년도 전자공학과 교육과정" 게시글 첨부 "2024 전자정보대학.pdf" (등록 2026-03-18)
//   · 과목/학수번호/학점/이수학년/개설학기 : [별표1] 교육과정 편성표 (52과목)
//   · 선수과목(prerequisites)             : [별표4] 선수과목 지정표 (39건)
//   · 트랙(tracks)                        : 제6조 [표2] 전공심화 분류 (통신·신호 / 회로·시스템 / 반도체·파동)
//   · 졸업이수학점 130 (전공기초25+전공필수26+전공선택28=79)  : 제3조 [표1], 제11조·제12조
// 비고: 개설학기가 1·2학기 동시개설인 과목은 [별표3] 학년별 편성표의 주(主)개설학기 기준으로 1개 슬롯 배치.
//       2024학번은 2026학번과 과목 구성이 대부분 동일하나, 전공필수 'Adventure Design'(EE212, 3학점)이 추가로
//       편성되어 있었음(이후 학번에서 폐지). 나머지 51과목은 2026학번과 학수번호/학점/트랙 동일.
// -------------------------------------------------------------------------
window.CURRICULA["EE"]["2024"] = {
    gradReq: 130, // 최저 졸업이수학점 (제11조)
    courses: [
        // ===== 전공기초 (편성 27학점 / 이수요건 25학점) =====
        // 1학년 1학기
        ...
        // ===== 전공필수 (26학점) =====
        // 1학년 1학기
        {code:"EE212", name:"AdventureDesign", type:"전공 필수", credits:3, year:1, sem:1, track:"CSY"},
        // 2학년 1학기
    ...
    // 2024학번 특이사항: EE497(종합설계) 선수과목에 EE212(Adventure Design)가 추가로 포함됨(2026학번엔 미해당, AdventureDesign 폐지로 자동 제외).
    prerequisites: [
        ...
        {target:"EE497", prereqs:["EE212", "EE207", "EE210", "EE213"]}, // 종합설계 ← AdventureDesign, 기초회로실험, 신호와시스템, 객체지향프로그래밍및실습 (모두 수강)
        {target:"EE470", prereqs:["EE206"]},                // SoC설계 ← 전자회로1
        {target:"EE242", prereqs:["EE202"]}                 // 회로이론2 ← 회로이론
    ],

    // [별표2]/제6조 [표2] 전공심화 분류 기반 진로 트랙별 추천 과목 (2026학번과 동일 매핑; EE212는 트랙 성격상 미해당)
    tracks: {
